...
IN="/scratch/au08019/reviopeanut/assembly/50k_files"
OUT="/scratch/au08019/reviopeanut/assembly/paf"
GENOFILE="/scratch/au08019/reviopeanut/assembly/50k_files/genos.txt"
...
minimap2 -x asm5 -t 32 "$REF" "$IN/$FA" > "$OUT/${FA%.fa}_vs_Tifrunner.paf"

echo "Done: $OUT/${FA%.fa}_vs_Tifrunner.paf"
